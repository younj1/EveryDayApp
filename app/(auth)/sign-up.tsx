...
export default function SignUpScreen() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (!access_token || !refresh_token) throw new Error('Missing tokens in redirect URL')
  ...
  return (
    <View className="flex-1 bg-white px-6 justify-center">
      ...
      <TouchableOpacity
        ...
        disabled={loading}
      >
        {loading ? <ActivityIndicator color="#fff" /> : <Text className="text-white font-semibold text-base">Sign Up</Text>}
      </TouchableOpacity>
      ...
      <TouchableOpacity className="items-center" onPress={() => router.replace('/(auth)/sign-in')}>
